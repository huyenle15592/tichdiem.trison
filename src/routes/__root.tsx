...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Yến sào Trí Sơn - Tích điểm Thành viên" },
      { name: "description", content: "Hệ thống tích điểm tri ân khách hàng Yến sào Trí Sơn." },
      { name: "author", content: "Yến sào Trí Sơn" },
